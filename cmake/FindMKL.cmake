...
if(WIN32)
	if(${CMAKE_CL_64} EQUAL 1)
		find_path(MKL_LIBRARY_DIRS mkl_core.lib HINTS $ENV{MKLROOT}/lib/intel64 $ENV{MKLROOT}/lib/win-x64)
...
if(MKL_INCLUDE_DIRS AND MKL_LIBRARY_DIRS)
    ...
    set(BLAS_LIBRARIES ${INT_LIB} ${SEQ_LIB} ${COR_LIB} ${OMP_LIB} ${THR_LIB} ${MAT_LIB} ${LDL_LIB})
    set(MKL_FOUND ON)
endif()
