...
elseif(APPLE)
    ...
    find_file(LIBOPENBLAS libopenblas64.so HINTS "${BLAS_DIR}/lib/x86_64-linux-gnu")
    find_file(LIBLAPACKE liblapacke64.so HINTS "${BLAS_DIR}/lib/x86_64-linux-gnu")
    set(BLAS_LIBRARIES ${LIBOPENBLAS} ${LIBLAPACKE})
    set(BLAS_LIBRARY_DIRS "${BLAS_DIR}/lib/x86_64-linux-gnu")
    set(BLAS_BINARY_DIRS "${BLAS_DIR}/lib/x86_64-linux-gnu")
endif()

find_path(BLAS_INCLUDE_DIRS cblas.h HINTS ${BLAS_DIR}/include ${BLAS_DIR}/include/x86_64-linux-gnu ${BLAS_DIR}/include/x86_64/linux-gnu)
