...
TEST(TestLinalg, TestExpm)
{
    ...
    // clang-format off
    Matrix<double> ans(Kokkos::dextents<Sci::index, 2>(3, 3), ans_data);
    Matrix<double> A(Kokkos::dextents<Sci::index, 2>(3, 3), A_data);
...
TEST(TestLinalg, TestExpmColMajor)
{
    ...
    // clang-format off
    Matrix<double, Kokkos::layout_left> ans(Kokkos::dextents<Sci::index, 2>(3, 3), ans_data);
    Matrix<double, Kokkos::layout_left> A(Kokkos::dextents<Sci::index, 2>(3, 3), A_data);
