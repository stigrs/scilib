...
inline void
inv(Kokkos::mdspan<T_a, Kokkos::extents<IndexType, nrows, ncols>, Layout, Accessor_a> a,
    Kokkos::mdspan<T_res, Kokkos::extents<IndexType, nrows, ncols>, Layout, Accessor_res> res)
{
