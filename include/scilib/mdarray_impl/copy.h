...
inline void copy(stdex::mdspan<T_x, stdex::extents<index, ext_x>, Layout_x, Accessor_x> x,
...
template <class T_x,
    ...
    requires(!std::is_const_v<T_y>)
inline void
copy(stdex::mdspan<T_x, stdex::extents<index, nrows_x, ncols_x>, Layout_x, Accessor_x> x,
     stdex::mdspan<T_y, stdex::extents<index, nrows_y, ncols_y>, Layout_y, Accessor_y> y)
{
    ...
    for (index_type i = 0; i < y.extent(0); ++i) {
        for (index_type j = 0; j < y.extent(1); ++j) {
            y(i, j) = x(i, j);
        }
    }
}
...
template <class T_x,
    ...
    requires(!std::is_const_v<T_y>)
inline void
copy(stdex::mdspan<T_x, stdex::extents<index, n1_x, n2_x, n3_x>, Layout_x, Accessor_x> x,
     stdex::mdspan<T_y, stdex::extents<index, n1_y, n2_y, n3_y>, Layout_y, Accessor_y> y)
{
    ...
    for (index_type i = 0; i < y.extent(0); ++i) {
        for (index_type j = 0; j < y.extent(1); ++j) {
            for (index_type k = 0; k < y.extent(2); ++k) {
                y(i, j, k) = x(i, j, k);
            }
        }
    }
...
template <class T_x,
    ...
    requires(!std::is_const_v<T_y>)
inline void
copy(stdex::mdspan<T_x, stdex::extents<index, n1_x, n2_x, n3_x, n4_x>, Layout_x, Accessor_x> x,
     stdex::mdspan<T_y, stdex::extents<index, n1_y, n2_y, n3_y, n4_y>, Layout_y, Accessor_y> y)
{
    ...
    for (index_type i = 0; i < y.extent(0); ++i) {
        for (index_type j = 0; j < y.extent(1); ++j) {
            for (index_type k = 0; k < y.extent(2); ++k) {
                for (index_type l = 0; l < y.extent(3); ++l) {
                    y(i, j, k, l) = x(i, j, k, l);
                }
            }
        }
    ...
    stdex::mdspan<T_y, stdex::extents<index, n1_y, n2_y, n3_y, n4_y, n5_y>, Layout_y, Accessor_y> y)
{
    ...
    for (index_type i1 = 0; i1 < y.extent(0); ++i1) {
        for (index_type i2 = 0; i2 < y.extent(1); ++i2) {
            for (index_type i3 = 0; i3 < y.extent(2); ++i3) {
                for (index_type i4 = 0; i4 < y.extent(3); ++i4) {
                    for (index_type i5 = 0; i5 < y.extent(4); ++i5) {
    ...
    for (index_type i1 = 0; i1 < y.extent(0); ++i1) {
        for (index_type i2 = 0; i2 < y.extent(1); ++i2) {
            for (index_type i3 = 0; i3 < y.extent(2); ++i3) {
                for (index_type i4 = 0; i4 < y.extent(3); ++i4) {
                    for (index_type i5 = 0; i5 < y.extent(4); ++i5) {
                        for (index_type i6 = 0; i6 < y.extent(5); ++i6) {
        ...
        for (index_type i2 = 0; i2 < y.extent(1); ++i2) {
            for (index_type i3 = 0; i3 < y.extent(2); ++i3) {
                for (index_type i4 = 0; i4 < y.extent(3); ++i4) {
                    for (index_type i5 = 0; i5 < y.extent(4); ++i5) {
                        for (index_type i6 = 0; i6 < y.extent(5); ++i6) {
                            for (index_type i7 = 0; i7 < y.extent(6); ++i7) {
