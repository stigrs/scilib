...
void for_each_in_extents(Callable&& f, Kokkos::extents<IndexType, Extents...> e, Layout)
{
...
void for_each_in_extents(
    Callable&& f,
    Kokkos::mdspan<ElementType, Kokkos::extents<IndexType, Extents...>, Layout, Accessor> m)
{
